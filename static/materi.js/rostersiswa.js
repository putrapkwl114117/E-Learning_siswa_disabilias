 // Paste the JavaScript code here
        ...
        function tentukanWarnaLatarBelakang(hari, jamMulai, jamSelesai) {
            const hariSaatIni = new Date().toLocaleDateString("en-US", {
                weekday: "long",
            });
        ...
        // Panggil fungsi untuk menampilkan jadwal mapel saat halaman dimuat
        document.addEventListener("DOMContentLoaded", tampilkanJadwalMapel);
